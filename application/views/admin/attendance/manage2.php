...
<body>
    ...
    <div class="header-wrapper">
        <h1 id="pageTitle">Worker Attendance: <span class="worker-title" id="displayWorkerName">Loading...</span></h1>
        <h1 id="pageTitle">Worker History<span class="worker-title" id="displayWorkerName"></span></h1>
